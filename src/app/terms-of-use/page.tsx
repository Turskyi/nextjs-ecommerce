...
import { DOMAIN, DEVELOPER_DOMAIN } from '../../../constants';

export default function TermsOfUse() {
  return (
    <div className='bg-body background-color text-body color p-5'>
      <Head>
        <title>Terms of Use - Anna&apos;s Artistic Store</title>
        <meta
          name='description'
          content="Terms of Use for Anna's Artistic Store."
        />
      ...
      <main className='container mx-auto'>
        <h1 className='text-4xl font-bold mb-6'>
          Anna&apos;s Artistic Store&apos;s Terms of Use
        </h1>
        ...
        <section className='mb-6'>
          ...
          <p className='text-lg mb-4'>
            ...
            use of Anna&apos;s Artistic Store&apos;s Website, located at
            {DOMAIN}.
          </p>
          <p className='text-lg mb-4'>
            By accessing this website we assume you accept these terms and
            conditions. Do not continue to use Anna&apos;s Artistic Store if you
        ...
        <section className='mb-6'>
          ...
          <p className='text-lg mb-4'>
            ...
            and operated by Anna and Dmytro Turskyi (&quot;We,&quot;
          ...
          <p className='text-lg mb-4'>
            ...
            trademarks, trade names, and service marks owned by Anna and Dmytro
            Turskyi or our affiliates. Additionally, other trademarks, trade
            names, and service marks used or displayed on this Website may be
            the registered and unregistered trademarks, trade names, and service
            marks of their respective third-party owners. Nothing contained on
            this Website should be construed as granting, by implication,
            estoppel, or otherwise, any license or right to use any trademarks,
            trade names, service marks, or logos displayed herein without the
            express written permission of Anna and Dmytro Turskyi or such
            third-party owner.
          </p>
        </section>

        <section className='mb-6'>
          <h2 className='text-3xl font-bold mb-4'>Your use of our website</h2>
          <p className='text-lg mb-4'>
          ...
          <p className='text-lg mb-4'>
            ...
            or any other customer of Anna and Dmytro Turskyi, including any
            shopping account that is not held by you, in any way where the
          ...
          <p className='text-lg mb-4'>
            You may use the Website for the purposes of viewing or shopping for
            Anna&apos;s® products, and to use any other features and services
            purposely provided by us on the Website.
          </p>
        </section>
        ...
        <section className='mb-6'>
          ...
          <p className='text-lg mb-4'>
            ...
            otherwise provide to Anna&Dmytro is original to you, that you own
            all applicable legal rights in the User Content, and that the User
            Content does not and will not infringe upon the rights of any other
            person or entity and all “moral rights” that you may have in such
            User Content have been voluntarily waived by you. You warrant,
            certify and represent that any individuals depicted in any User
            Content, have reached the age of majority in their respective
            jurisdiction of residence; and you grant Anna&Dmytro the right to
            copy, edit, change, revise, display, perform, publish, distribute
            the likenesses of those individuals and that you have the authority
            to attest to this release on their behalf. If any of the individuals
            depicted in any User Content are minors in their respective
            jurisdiction of residence, you certify, warrant and represent that
            you are the parent or legal guardian of each such individual and you
            grant the use of the media containing his/her depiction in
            accordance with the Terms. By submitting User Content, and subject
            to our privacy policy in respect of personal information, you: (i)
            grant to Anna&Dmytro a world-wide, perpetual, irrevocable,
            ...
            Anna&Dmytro. For greater certainty, this means that, among other
            things, Anna&Dmytro has the right to use any and all ideas you
            submit (including ideas about our products, services, publications
            or advertising campaigns) in any manner that we choose, without any
            notice or obligation to you whatsoever.
          </p>
          <p className='text-lg mb-4'>
        ...
        <section className='mb-6'>
          <h2 className='text-3xl font-bold mb-4'>User Content Rules</h2>
          <p className='text-lg mb-4'>
          ...
          <p className='text-lg mb-4'>
            ...
            Anna & Dmytro Turskyi responsible for any User Communication or User
            Content from other users that you access on the Website. We reserve
